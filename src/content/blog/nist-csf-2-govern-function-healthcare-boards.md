...
A healthcare board that owns CSF 2.0 Govern is materially better positioned for an OCR investigation than a board that treats cybersecurity as an operational concern. See [OCR's Risk Analysis Initiative and the Cascade Eye Settlement](/blog/ocr-risk-analysis-initiative-cascade-eye) for the enforcement framing.
