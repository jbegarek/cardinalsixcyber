...
The [single-artifact, multi-authority evidence engineering](/blog/single-artifact-multi-authority-evidence-engineering) framing applies directly. Anchor artifacts plus a control-mapping matrix produce framework agility; framework-specific artifacts produce framework lock-in.
